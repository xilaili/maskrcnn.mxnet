...
class MutableModule(BaseModule):
    ...
    def bind(self, data_shapes, label_shapes=None, for_training=True,
        ...
        print max_data_shapes
        module = Module(self._symbol, self._data_names, self._label_names, logger=self.logger,
                        context=self._context, work_load_list=self._work_load_list,
                        fixed_param_names=self._fixed_param_names)
        module.bind([max_data_shapes for _ in xrange(len(self._context))], [max_label_shapes for _ in xrange(len(self._context))], for_training, inputs_need_grad,
