...
#define __PYX_HAVE__gpu_mv
#define __PYX_HAVE_API__gpu_mv
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'gpu_mv' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_int32_t = { "int32_t", NULL, sizeof(__pyx_t_5numpy_int32_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_int32_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_int32_t), 0 };
#define __Pyx_MODULE_NAME "gpu_mv"
int __pyx_module_is_main_gpu_mv = 0;

/* Implementation of 'gpu_mv' */
...
static const char __pyx_k_gpu_mv[] = "gpu_mv";
...
static const char __pyx_k_home_xli47_src_FCIS_lib_mask_gp[] = "/home/xli47/src/FCIS/lib/mask/gpu_mv.pyx";
...
static PyObject *__pyx_n_s_gpu_mv;
static PyObject *__pyx_kp_s_home_xli47_src_FCIS_lib_mask_gp;
...
/* Python wrapper */
static PyObject *__pyx_pw_6gpu_mv_1mv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6gpu_mv_1mv = {"mv", (PyCFunction)__pyx_pw_6gpu_mv_1mv, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6gpu_mv_1mv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("gpu_mv.mv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_6gpu_mv_mv(__pyx_self, __pyx_v_all_boxes, __pyx_v_all_masks, __pyx_v_candidate_inds, __pyx_v_candidate_start, __pyx_v_candidate_weights, __pyx_v_binary_thresh, __pyx_v_image_height, __pyx_v_image_width, __pyx_v_device_id);
 ...
 */
    ...
    _mv((&(*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_all_boxes.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_all_boxes.diminfo[0].strides, __pyx_t_10, __pyx_pybuffernd_all_boxes.diminfo[1].strides))), (&(*__Pyx_BufPtrStrided4d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_all_masks.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_all_masks.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_all_masks.diminfo[1].strides, __pyx_t_14, __pyx_pybuffernd_all_masks.diminfo[2].strides, __pyx_t_15, __pyx_pybuffernd_all_masks.diminfo[3].strides))), __pyx_v_all_box_num, (&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int32_t *, __pyx_pybuffernd_candidate_inds.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_candidate_inds.diminfo[0].strides))), (&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int32_t *, __pyx_pybuffernd_candidate_start.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_candidate_start.diminfo[0].strides))), (&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_candidate_weights.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_candidate_weights.diminfo[0].strides))), __pyx_v_candidate_num, __pyx_v_binary_thresh, __pyx_v_image_height, __pyx_v_image_width, __pyx_v_boxes_dim, __pyx_v_mask_size, (__pyx_v_candidate_start->dimensions[0]), (&(*__Pyx_BufPtrStrided4d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_result_mask.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_result_mask.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_result_mask.diminfo[1].strides, __pyx_t_21, __pyx_pybuffernd_result_mask.diminfo[2].strides, __pyx_t_22, __pyx_pybuffernd_result_mask.diminfo[3].strides))), (&(*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int32_t *, __pyx_pybuffernd_result_box.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_result_box.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_result_box.diminfo[1].strides))), __pyx_v_device_id);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_gpu_mv, __pyx_k_gpu_mv, sizeof(__pyx_k_gpu_mv), 0, 0, 1, 1},
  {&__pyx_kp_s_home_xli47_src_FCIS_lib_mask_gp, __pyx_k_home_xli47_src_FCIS_lib_mask_gp, sizeof(__pyx_k_home_xli47_src_FCIS_lib_mask_gp), 0, 0, 1, 0},
 ...
 *                 np.ndarray[np.int32_t, ndim=1] candidate_inds,
 */
  __pyx_tuple__10 = PyTuple_Pack(16, __pyx_n_s_all_boxes, __pyx_n_s_all_masks, __pyx_n_s_candidate_inds, __pyx_n_s_candidate_start, __pyx_n_s_candidate_weights, __pyx_n_s_binary_thresh, __pyx_n_s_image_height, __pyx_n_s_image_width, __pyx_n_s_device_id, __pyx_n_s_all_box_num, __pyx_n_s_boxes_dim, __pyx_n_s_mask_size, __pyx_n_s_candidate_num, __pyx_n_s_result_num, __pyx_n_s_result_mask, __pyx_n_s_result_box); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(9, 0, 16, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_xli47_src_FCIS_lib_mask_gp, __pyx_n_s_mv, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_gpu_mv) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gpu_mv")) {
      if (unlikely(PyDict_SetItemString(modules, "gpu_mv", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                 np.ndarray[np.int32_t, ndim=1] candidate_inds,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6gpu_mv_1mv, NULL, __pyx_n_s_gpu_mv); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gpu_mv", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gpu_mv");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
